...
namespace Task1_platform
{
    class Student
    {
        ...
        Student()
        {
            ...
            GroupNumber = 301;
            ExamInfo = new Exam[] { new Exam(), new Exam("B5", 4, new DateTime()) };
        }
        ...
        static void Main(string[] args)
        {
            ...
            T = new Student(new Person("Vlad", "Mordasov", new DateTime(1998, 10, 19)), Person.Education.Bachelor, 311);

            Console.WriteLine(T.ToString());

            T.AddExam(new Exam[] { new Exam("C#", 5, new DateTime()), new Exam("Inform Sistem", 4, new DateTime()) });
            ...
            //Одновимірний масив
            A[0] = new Exam("B5", 4, new DateTime());
            ...
            //Двовимірний масив            
            B[0, 0] = new Exam("B5", 4, new DateTime());
            ...
            C[0] = new Exam[800000];
            C[1] = new Exam[200000];
            C[0][0] = new Exam("B5", 4, new DateTime());
            start = DateTime.UtcNow.Ticks;
